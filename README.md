...
## Task 3 : Test with/without cache

**Without caching** - Time : 20s<br>
https://github.com/tomvieilledent/holbertonschool-continuous_integration/actions/runs/32828308957

**With caching** - Time : 19s<br>
https://github.com/tomvieilledent/holbertonschool-continuous_integration/actions/runs/32828468196

## Task 4 : Build your image in CI

https://github.com/tomvieilledent/holbertonschool-continuous_integration/actions/runs/32963970079

## Task 5 : Publish to a registry
...
## Task 6 : Tag it like you mean it

Tags (`sha`, branch, `latest`, semver on a git tag) are generated by `docker/metadata-action`. Pushing tag `v1.0.0` produces image tag `1.0.0`:<br>
https://github.com/tomvieilledent/holbertonschool-continuous_integration/actions/runs/33207699663

## Task 7 : Make the build fast
